...
public class DefaultResultHandler implements ResultHandler {
    ...
    @Override
    public <T> T handle(Result result)throws IllegalAccessException, InvocationTargetException, InstantiationException  {
	...
	for(FieldMapping fieldMapping : fieldMappingSet){
	    fieldName = fieldMapping.getField().getName();
    ...
    public Object getFieldValue(byte[] bytes, FieldMapping fieldMapping){
