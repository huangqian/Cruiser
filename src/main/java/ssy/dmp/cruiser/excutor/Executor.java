...
public interface Executor{
    ...
    <E> void put(E e, byte[] rowKey) throws IllegalAccessException, IOException, EncodeException;

    <E> void put(Map<byte[], E> map) throws IllegalAccessException, IOException, EncodeException;
